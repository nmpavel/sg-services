...
/**
 * RemoteRecruit angular "R" monogram.
 * Paths copied verbatim from design/REMOTE RECRUIT sign color background blue.svg
 * (exact vector colors: #50C0E3 cyan + #FFFFFE white).
 */
